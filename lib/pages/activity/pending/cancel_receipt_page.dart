...
class CancelReceiptPage extends StatefulWidget {
  const CancelReceiptPage({Key key}) : super(key: key);

  @override
  _CancelReceiptPageState createState() => _CancelReceiptPageState();
}

class _CancelReceiptPageState extends State<CancelReceiptPage> {
  @override
